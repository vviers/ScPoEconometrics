...
The resulting output is called a "correlation matrix". The correlation between any variable and itself is obviously 1, hence the ones on the diagonal of the matrix. What we are interested in are the coefficients of the off-diagonal: $Cov(X, Y) = Cov(Y, X) =$ `r cor(x, y)[1]`. This is a fairly high correlation coefficient, which is unsurprising as the data is made up.
